...
**Documented:** #180 addresses token slowness/transient failure and cancellation. **Corroborated:** named OAuth and separate PRN registrations. **Inference:** execution-context difference explains, but is not an explicit rationale for, the split.
