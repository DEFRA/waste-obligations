...
public static class PrnDataFixture
{
    ...
    public static IPostprocessComposer<PrnData> Default()
    {
        return new Fixture()
            .Build<PrnData>()
            ...
            .With(x => x.IssueDate, new DateTime(2025, 6, 15, 10, 30, 0, DateTimeKind.Utc))
            ...
            .With(x => x.CreatedOn, new DateTime(2026, 1, 15, 10, 0, 0, DateTimeKind.Utc))
            .With(x => x.LastUpdatedDate, new DateTime(2026, 1, 15, 10, 5, 0, DateTimeKind.Utc))
