using WasteObligations.Example.Endpoints;
using WasteObligations.Example.Services;
using WasteObligations.Utils;
using WasteObligations.Utils.Http;
using WasteObligations.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using WasteObligations.Config;
using WasteObligations.Utils.Logging;
